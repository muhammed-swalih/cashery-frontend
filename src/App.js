...
import Bilogin from "./components/bilogin/Bilogin";
import BusinessBefore from "./components/businessBefore/BusinessBefore";
import Perfomance from "./components/productPerfomance/Perfomance";
function App() {
  return (
    <div className="App">
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/bilogin" element={<Bilogin />} />
          <Route path="/before" element={<BusinessBefore />} />
